    ...
    <el-form ref="form" :model="form" :rules="rules" class="form-container">
      ...
      <div class="createPost-main-container">
        ...
        <el-form-item prop="content" style="margin-bottom: 30px;">
          <mavon-editor v-model="form.content" ref="md" @imgAdd="handleEditorImgAdd" @imgDel="ImgDel"
...
<script>
  ...
  import {upload,delLocalStorage} from "@/api/tool/local";
  ...
  export default {
    ...
    methods: {
      ...
      handleEditorImgAdd(pos, $file) {
        ...
        uploadImgToQiNiu(formdata).then((response) => {
